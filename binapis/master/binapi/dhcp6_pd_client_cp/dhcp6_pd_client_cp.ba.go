...
// source: binapis/master/vppapi/plugins/dhcp6_pd_client_cp.api.json
...
type DHCP6PdClientEnableDisable struct {
	...
	PrefixGroup string `struc:"[64]byte"`
	Enable      bool
}
...
type IP6AddDelAddressUsingPrefix struct {
	SwIfIndex         InterfaceIndex
	PrefixGroup       string `struc:"[64]byte"`
	AddressWithPrefix IP6AddressWithPrefix
	IsAdd             bool
}
