...
// source: binapis/master/vppapi/core/pg.api.json
...
type PgCapture struct {
	...
	IsEnabled           bool
	Count               uint32
	XXX_PcapFileNameLen uint32 `struc:"sizeof=PcapFileName"`
	PcapFileName        string
}
...
type PgEnableDisable struct {
	IsEnabled         bool
	XXX_StreamNameLen uint32 `struc:"sizeof=StreamName"`
	StreamName        string
}
