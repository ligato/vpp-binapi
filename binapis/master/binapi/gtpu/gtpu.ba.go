...
// source: binapis/master/vppapi/plugins/gtpu.api.json
...
// GtpuOffloadRx represents VPP binary API message 'gtpu_offload_rx'.
...
func (*GtpuOffloadRx) GetMessageType() api.MessageType { return api.RequestMessage }

// GtpuOffloadRxReply represents VPP binary API message 'gtpu_offload_rx_reply'.
...
func (*GtpuOffloadRxReply) GetMessageType() api.MessageType { return api.ReplyMessage }
...
func init() {
	...
	api.RegisterMessage((*GtpuOffloadRx)(nil), "gtpu.GtpuOffloadRx")
	api.RegisterMessage((*GtpuOffloadRxReply)(nil), "gtpu.GtpuOffloadRxReply")
