...
// source: binapis/master/vppapi/core/lldp.api.json
...
type LldpConfig struct {
	TxHold            uint32
	TxInterval        uint32
	XXX_SystemNameLen uint32 `struc:"sizeof=SystemName"`
	SystemName        string
}
...
type SwInterfaceSetLldp struct {
	...
	Enable          bool
	XXX_PortDescLen uint32 `struc:"sizeof=PortDesc"`
	PortDesc        string
}
