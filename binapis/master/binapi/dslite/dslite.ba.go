...
// source: binapis/master/vppapi/plugins/dslite.api.json

/*
Package dslite is a generated VPP binary API for 'dslite' module.
...
func init() {
	api.RegisterMessage((*DsliteAddDelPoolAddrRange)(nil), "dslite.DsliteAddDelPoolAddrRange")
	api.RegisterMessage((*DsliteAddDelPoolAddrRangeReply)(nil), "dslite.DsliteAddDelPoolAddrRangeReply")
	api.RegisterMessage((*DsliteAddressDetails)(nil), "dslite.DsliteAddressDetails")
	api.RegisterMessage((*DsliteAddressDump)(nil), "dslite.DsliteAddressDump")
	api.RegisterMessage((*DsliteGetAftrAddr)(nil), "dslite.DsliteGetAftrAddr")
	api.RegisterMessage((*DsliteGetAftrAddrReply)(nil), "dslite.DsliteGetAftrAddrReply")
	api.RegisterMessage((*DsliteGetB4Addr)(nil), "dslite.DsliteGetB4Addr")
	api.RegisterMessage((*DsliteGetB4AddrReply)(nil), "dslite.DsliteGetB4AddrReply")
	api.RegisterMessage((*DsliteSetAftrAddr)(nil), "dslite.DsliteSetAftrAddr")
	api.RegisterMessage((*DsliteSetAftrAddrReply)(nil), "dslite.DsliteSetAftrAddrReply")
	api.RegisterMessage((*DsliteSetB4Addr)(nil), "dslite.DsliteSetB4Addr")
	api.RegisterMessage((*DsliteSetB4AddrReply)(nil), "dslite.DsliteSetB4AddrReply")
}
...
// RPCService represents RPC service API for dslite module.
