...
// source: binapis/master/vppapi/plugins/nat.api.json
...
// Nat44DelUser represents VPP binary API message 'nat44_del_user'.
...
func (*Nat44DelUser) GetMessageType() api.MessageType { return api.RequestMessage }

// Nat44DelUserReply represents VPP binary API message 'nat44_del_user_reply'.
...
func (*Nat44DelUserReply) GetMessageType() api.MessageType { return api.ReplyMessage }
...
// Nat44SessionCleanup represents VPP binary API message 'nat44_session_cleanup'.
...
func (*Nat44SessionCleanup) GetMessageType() api.MessageType { return api.RequestMessage }

// Nat44SessionCleanupReply represents VPP binary API message 'nat44_session_cleanup_reply'.
...
func init() {
	...
	api.RegisterMessage((*Nat44DelUser)(nil), "nat.Nat44DelUser")
	api.RegisterMessage((*Nat44DelUserReply)(nil), "nat.Nat44DelUserReply")
