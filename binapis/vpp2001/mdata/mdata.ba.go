...
// source: binapis/vpp2001/.vppapi/plugins/mdata.api.json

/*
Package mdata is a generated VPP binary API for 'mdata' module.
...
// MdataEnableDisable represents VPP binary API message 'mdata_enable_disable'.
...
func (*MdataEnableDisable) GetMessageType() api.MessageType { return api.RequestMessage }

// MdataEnableDisableReply represents VPP binary API message 'mdata_enable_disable_reply'.
...
func (*MdataEnableDisableReply) GetMessageType() api.MessageType { return api.ReplyMessage }

func init() {
	api.RegisterMessage((*MdataEnableDisable)(nil), "mdata.MdataEnableDisable")
	api.RegisterMessage((*MdataEnableDisableReply)(nil), "mdata.MdataEnableDisableReply")
}
...
// RPCService represents RPC service API for mdata module.
