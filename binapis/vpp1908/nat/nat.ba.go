...
// source: binapis/vpp1908/.vppapi/plugins/nat.api.json
...
func (*NatReassDetails) GetCrcString() string            { return "dbef31be" }
...
func (*NatSetReass) GetCrcString() string            { return "364ce510" }
