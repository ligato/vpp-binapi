...
// source: binapis/vpp1908/.vppapi/core/vhost_user.api.json
...
func (*CreateVhostUserIf) GetCrcString() string            { return "a3438cd4" }
...
func (*ModifyVhostUserIf) GetCrcString() string            { return "3fd4c094" }
