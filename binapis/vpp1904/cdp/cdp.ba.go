...
// source: binapis/vpp1904/.vppapi/plugins/cdp.api.json
...
func (*CdpEnableDisable) GetCrcString() string            { return "4eec6097" }
func (*CdpEnableDisable) GetMessageType() api.MessageType { return api.RequestMessage }
...
func (*CdpEnableDisableReply) GetMessageType() api.MessageType { return api.ReplyMessage }
