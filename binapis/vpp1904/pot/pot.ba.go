...
// source: binapis/vpp1904/.vppapi/plugins/pot.api.json
...
func (*PotProfileActivate) GetCrcString() string            { return "eeada566" }
func (*PotProfileActivate) GetMessageType() api.MessageType { return api.RequestMessage }
...
func (*PotProfileActivateReply) GetMessageType() api.MessageType { return api.ReplyMessage }
...
func (*PotProfileAdd) GetCrcString() string            { return "e8f1d058" }
func (*PotProfileAdd) GetMessageType() api.MessageType { return api.RequestMessage }
...
func (*PotProfileAddReply) GetMessageType() api.MessageType { return api.ReplyMessage }
...
func (*PotProfileDel) GetCrcString() string            { return "bb100832" }
func (*PotProfileDel) GetMessageType() api.MessageType { return api.RequestMessage }
...
func (*PotProfileDelReply) GetMessageType() api.MessageType { return api.ReplyMessage }
...
func (*PotProfileShowConfigDetails) GetMessageType() api.MessageType { return api.ReplyMessage }
...
func (*PotProfileShowConfigDump) GetMessageType() api.MessageType { return api.RequestMessage }
