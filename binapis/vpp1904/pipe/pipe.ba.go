...
// source: binapis/vpp1904/.vppapi/core/pipe.api.json
...
func (*PipeCreate) GetCrcString() string            { return "db413409" }
func (*PipeCreate) GetMessageType() api.MessageType { return api.RequestMessage }
...
func (*PipeCreateReply) GetCrcString() string            { return "9f0eef14" }
func (*PipeCreateReply) GetMessageType() api.MessageType { return api.ReplyMessage }
...
func (*PipeDelete) GetCrcString() string            { return "529cb13f" }
func (*PipeDelete) GetMessageType() api.MessageType { return api.RequestMessage }
...
func (*PipeDeleteReply) GetMessageType() api.MessageType { return api.ReplyMessage }
...
func (*PipeDetails) GetCrcString() string            { return "91286b09" }
func (*PipeDetails) GetMessageType() api.MessageType { return api.ReplyMessage }
...
func (*PipeDump) GetMessageType() api.MessageType { return api.RequestMessage }
