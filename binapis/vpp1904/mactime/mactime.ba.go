...
// source: binapis/vpp1904/.vppapi/plugins/mactime.api.json
...
func (*TimeRange) GetCrcString() string { return "941c191b" }
...
func (*MactimeAddDelRange) GetCrcString() string            { return "2b1821d5" }
...
func (*MactimeEnableDisable) GetCrcString() string            { return "57298519" }
