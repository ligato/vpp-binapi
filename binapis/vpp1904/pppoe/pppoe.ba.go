...
// source: binapis/vpp1904/.vppapi/plugins/pppoe.api.json
...
func (*PppoeAddDelSession) GetCrcString() string            { return "766cbfeb" }
func (*PppoeAddDelSession) GetMessageType() api.MessageType { return api.RequestMessage }
...
func (*PppoeAddDelSessionReply) GetCrcString() string            { return "fda5941f" }
func (*PppoeAddDelSessionReply) GetMessageType() api.MessageType { return api.ReplyMessage }
...
func (*PppoeSessionDetails) GetCrcString() string            { return "358fc7a8" }
func (*PppoeSessionDetails) GetMessageType() api.MessageType { return api.ReplyMessage }
...
func (*PppoeSessionDump) GetCrcString() string            { return "529cb13f" }
func (*PppoeSessionDump) GetMessageType() api.MessageType { return api.RequestMessage }
