...
// source: binapis/vpp1904/.vppapi/plugins/igmp.api.json
...
func (*GroupPrefix) GetTypeName() string  { return "group_prefix" }
func (*GroupPrefix) GetCrcString() string { return "5398e813" }
...
func (*IgmpGroup) GetTypeName() string  { return "igmp_group" }
func (*IgmpGroup) GetCrcString() string { return "c0f42621" }
...
func (*IgmpClearInterface) GetCrcString() string            { return "529cb13f" }
func (*IgmpClearInterface) GetMessageType() api.MessageType { return api.RequestMessage }
...
func (*IgmpClearInterfaceReply) GetMessageType() api.MessageType { return api.ReplyMessage }
...
func (*IgmpDetails) GetCrcString() string            { return "238a59f3" }
func (*IgmpDetails) GetMessageType() api.MessageType { return api.ReplyMessage }
...
func (*IgmpDump) GetCrcString() string            { return "529cb13f" }
func (*IgmpDump) GetMessageType() api.MessageType { return api.RequestMessage }
...
func (*IgmpEnableDisable) GetCrcString() string            { return "5bd2a570" }
func (*IgmpEnableDisable) GetMessageType() api.MessageType { return api.RequestMessage }
...
func (*IgmpEnableDisableReply) GetMessageType() api.MessageType { return api.ReplyMessage }
...
func (*IgmpEvent) GetCrcString() string            { return "b1122e50" }
func (*IgmpEvent) GetMessageType() api.MessageType { return api.ReplyMessage }
...
func (*IgmpGroupPrefixDetails) GetCrcString() string            { return "c6b0f93d" }
func (*IgmpGroupPrefixDetails) GetMessageType() api.MessageType { return api.ReplyMessage }
...
func (*IgmpGroupPrefixDump) GetMessageType() api.MessageType { return api.RequestMessage }
...
func (*IgmpGroupPrefixSet) GetCrcString() string            { return "7ae82c26" }
func (*IgmpGroupPrefixSet) GetMessageType() api.MessageType { return api.RequestMessage }
...
func (*IgmpGroupPrefixSetReply) GetMessageType() api.MessageType { return api.ReplyMessage }
...
func (*IgmpListen) GetCrcString() string            { return "a4973479" }
func (*IgmpListen) GetMessageType() api.MessageType { return api.RequestMessage }
...
func (*IgmpListenReply) GetMessageType() api.MessageType { return api.ReplyMessage }
...
func (*IgmpProxyDeviceAddDel) GetCrcString() string            { return "f753aab3" }
func (*IgmpProxyDeviceAddDel) GetMessageType() api.MessageType { return api.RequestMessage }
...
func (*IgmpProxyDeviceAddDelInterface) GetCrcString() string            { return "f753aab3" }
func (*IgmpProxyDeviceAddDelInterface) GetMessageType() api.MessageType { return api.RequestMessage }
...
func (*IgmpProxyDeviceAddDelInterfaceReply) GetMessageType() api.MessageType { return api.ReplyMessage }
...
func (*IgmpProxyDeviceAddDelReply) GetMessageType() api.MessageType { return api.ReplyMessage }
...
func (*WantIgmpEvents) GetMessageType() api.MessageType { return api.RequestMessage }
...
func (*WantIgmpEventsReply) GetMessageType() api.MessageType { return api.ReplyMessage }
