...
// source: binapis/vpp2005/.vppapi/core/gso.api.json

/*
Package gso is a generated VPP binary API for 'gso' module.
...
// FeatureGsoEnableDisable represents VPP binary API message 'feature_gso_enable_disable'.
...
func (*FeatureGsoEnableDisable) GetMessageType() api.MessageType { return api.RequestMessage }

// FeatureGsoEnableDisableReply represents VPP binary API message 'feature_gso_enable_disable_reply'.
...
func (*FeatureGsoEnableDisableReply) GetMessageType() api.MessageType { return api.ReplyMessage }

func init() {
	api.RegisterMessage((*FeatureGsoEnableDisable)(nil), "gso.FeatureGsoEnableDisable")
	api.RegisterMessage((*FeatureGsoEnableDisableReply)(nil), "gso.FeatureGsoEnableDisableReply")
}
...
// RPCService represents RPC service API for gso module.
